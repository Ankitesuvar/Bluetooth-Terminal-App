...
//        //Extra
//        String receivedString = new String(data);
//        String[] parts = receivedString.split(" "); // Split the string using the space as the delimiter
//        splitData.addAll(Arrays.asList(parts)); // Add the split parts to the splitData list
//        updateUI();
//        //Extra
//    }
...
//        for (byte[] data : datas) {
//            String receivedString = new String(data);
//            String[] parts = receivedString.split(" "); // Split the string using space as the delimiter
//            splitData.addAll(Arrays.asList(parts));           // Add the split parts to the splitData list
//        }
//        updateUI();
//        //Extra
...
//        int i = 0;
//        while (i < splitData.size()) {
//            if ((i+1) % 2 == 1) { // Check if the index is odd (0-based index i + 1 is even)
//                sb.append(i).append(": ").append(splitData.get(i)).append("\n");
//            }
//            i++;
//        }
